      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <figure class="illustration-2">
            <img src="{{ asset('assets/images/symptoms.png') }}" alt="Image" class="img-fluid">
          </figure>
        </div>
      ...
      <div class="row">
        <div class="col-lg-6 mb-4">
          <div class="symptom d-flex">
            <div class="img">
              <img src="{{ asset('assets/images/symptom_high-fever.png') }}" alt="Image" class="img-fluid">
            </div>
            <div class="text">
              <h3>High Fever</h3>
        ...
        <div class="col-lg-6 mb-4">
          <div class="symptom d-flex">
            <div class="img">
              <img src="{{ asset('assets/images/symptom_cough.png') }}" alt="Image" class="img-fluid">
            </div>
            <div class="text">
              <h3>Cough</h3>
        ...
        <div class="col-lg-6 mb-4">
          <div class="symptom d-flex">
            <div class="img">
              <img src="{{ asset('assets/images/symptom_sore-troath.png') }}" alt="Image" class="img-fluid">
            </div>
            <div class="text">
              <h3>Sore Troath</h3>
        ...
        <div class="col-lg-6 mb-4">
          <div class="symptom d-flex">
            <div class="img">
              <img src="{{ asset('assets/images/symptom_headache.png') }}" alt="Image" class="img-fluid">
            </div>
            <div class="text">
              <h3>Headache</h3>
